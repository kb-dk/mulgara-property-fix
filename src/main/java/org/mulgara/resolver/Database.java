...
public class Database implements SessionFactory, Closable {
     ...
     */
    protected StringPoolSessionFactory spSessionFactory = null;
     ...
     * Outside of initialization, this will always be <code>null</code>.
     */
    protected JRDFResolverSessionFactory jrdfSessionFactory = null;

    /**
     * The set of resolver factories that should have access to their models
     * cached.
     */
    protected final Set<ResolverFactory> cachedResolverFactorySet = new HashSet<ResolverFactory>();

    /**
     * Read-only view of {@link #cachedResolverFactorySet}.
     */
    protected final Set<ResolverFactory> unmodifiableCachedResolverFactorySet =
            Collections.unmodifiableSet(cachedResolverFactorySet);

    /**
     * The set of all registered {@link ContentHandler} instances.
     */
    protected final ContentHandlerManagerImpl contentHandlers;

    /**
     * The set of all registered {@link ResolverFactory} instances.
     */
    protected final List<ResolverFactory> resolverFactoryList = new ArrayList<ResolverFactory>();

    /**
     * Read-only view of {@link #resolverFactoryList}, safe to be handed out to
     * the resolver sessions.
     */
    protected final List<ResolverFactory> unmodifiableResolverFactoryList =
     ...
     * protocol.
     */
    protected final Map<String,ResolverFactory> externalResolverFactoryMap = new HashMap<String,ResolverFactory>();

    /**
     * Read-only view of {@link #externalResolverFactoryMap}, safe to be handed
     * out to the resolver sessions.
     */
    protected final Map<String,ResolverFactory> unmodifiableExternalResolverFactoryMap =
     ...
     */
    protected final Map<URI,InternalResolverFactory> internalResolverFactoryMap = new HashMap<URI,InternalResolverFactory>();

    /**
     * Read-only view of {@link #internalResolverFactoryMap}, safe to be handed
     * out to the resolver sessions.
     */
    protected final Map<URI,InternalResolverFactory> unmodifiableInternalResolverFactoryMap =
     ...
     */
    protected final MulgaraTransactionManager transactionManager;

    /** the default maximum duration for a transaction, in milli-seconds */
    protected final long defaultTransactionTimeout;
